...
import { GetAllStats, GetStatsByDate, GetTopPages, GetTotalViews, GetAudience } from "../../../Controllers/Stats/Web/GetStatsController.js";
...
router.get("/audience", VerifyPermissions("admin"), GetAudience);
